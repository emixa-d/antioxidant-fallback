...
(define %features
  `(("rust-arrow2" ,#~'("default" "compute" "io_csv" "io_ipc" "io_parquet" "io_json")) ; compute is required by rust-polars-core; "io_csv", "io_ipc", "io_parquet", "io_json" and by rust-polars-io
    ...
    ("rust-wayland-protocols" ,#~'("wayland-client" "wayland-server" "unstable_protocols")) ; unstable-protocols is required by (TODO: forgot which one).  TODO: bundles wayland protocol things
