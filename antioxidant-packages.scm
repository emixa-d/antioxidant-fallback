...
(define %removed-dependencies
  ...
  `("rust-derive-error-chain" ; doesn't build (even when updated) and unmaintained, avoid it for now
    ...
    "rust-winapi" "rust-kernel32-sys" "rust-user32-sys" "rust-winreg" "rust-wepoll-sys" "rust-wepoll-sys-stjepang" "rust-ipconfig" "rust-windows" "rust-windows-x86-64-msvc" "rust-windows-x86-64-gnu" "rust-windows-i686-msvc" "rust-windows-i686-gnu" "rust-windows-aarch64-msvc" "rust-windows-sys" "rust-windows-gen" "rust-windows-macros" ; skip Windows support for now
...
(define %features
  `(("rust-arrow2" ,#~'("default" "compute" "io_csv" "io_ipc" "io_parquet" "io_json")) ; compute is required by rust-polars-core; "io_csv", "io_ipc", "io_parquet", "io_json" and by rust-polars-io
    ...
    ("rust-polars-core" ,#~'("default" "dtype-time")) ; "dtype-time" required by rust-polars-io's csv support
